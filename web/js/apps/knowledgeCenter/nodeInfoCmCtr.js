/**
 * Created by wankang on 2017/2/13.
 */

angular.module('MaterialApp').controller('nodeInfoCmCtr', ['$scope', '$stateParams','$uibModal','$state', function($scope, $stateParams,$uibModal,$state) {
