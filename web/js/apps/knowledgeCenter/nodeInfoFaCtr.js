...
angular.module('MaterialApp').controller('nodeInfoFaCtr', ['$scope', '$stateParams', '$uibModal', '$state', function ($scope, $stateParams, $uibModal, $state) {
    ...
    grid.setUrl("/suite/plugins/servlet/query/GM_getfavoriteChilds");
    grid.load();
